...
var processCss = exports.processCss = function processCss(stylesInfo, options) {
  ...
  if (useSourceMaps) {
    ...
    transformedCss = addSourceMaps((0, _styleTransform2.default)(isGlobal ? '' : getPrefix(dynamic, staticClassName), css, {
      generator: generator,
    ...
    transformedCss = (0, _styleTransform2.default)(isGlobal ? '' : getPrefix(dynamic, staticClassName), css, { splitRules: splitRules });
  }
