        ...
        enter: function enter(path, state) {
          ...
          if (state.externalStyles.length > 0) {
            ...
            if (expressionsLength === 0) {
              ...
              externalJsxId = t.templateLiteral([t.templateElement({ raw: 'jsx-', cooked: '' })].concat((0, _toConsumableArray3.default)([].concat((0, _toConsumableArray3.default)(new Array(expressionsLength - 1))).map(function () {
                return t.templateElement({ raw: ' jsx-', cooked: ' ' });
